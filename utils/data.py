...
def raw_to_pos_fast(raw_file="Dataset/vertebrates.txt"):
...
def raw_to_neg_fast(raw_file="Dataset/vertebrates.txt"):
    # Initialize empty lists
    dna_data_point, label_data_point = [], []
    total_dna_data, total_label_data = [], []
    end, to_read_dna = False, False
...
def extract_arff_data(filepath="Dataset/Inframe_3_Gram.arff"):
    x = []
    y = []
